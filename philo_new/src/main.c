...
// void eat_fun(t_all *all)
// {
// 	pthread_mutex_lock(all->philo->right_fork);
// 	if (all->philo->death_flag == 1)
// 	{
// 		pthread_mutex_unlock(all->philo->right_fork);
// 		return ;
// 	}
// 	pthread_mutex_lock(all->philo->print_lock);
// 	printf("%d %d has taken a fork\n", get_work_time(all->start_time), all->philo->philo_index);
// 	pthread_mutex_unlock(all->philo->print_lock);
// 	pthread_mutex_unlock(all->philo->right_fork);
// }
...
// 	printf("death flag = %d\n", all->philo->death_flag);
// 	printf("death flag = %d\n", all->philo->need_to_eat);
// 	if (all->philo->philo_index % 2 == 0)
// 		usleep(200);
// 	while (all->philo->death_flag != 1 && all->philo->need_to_eat != 0)
// 	{
// 		printf("check\n");
// 		eat_fun(all);
// 	}
...
// 	printf("philo->death_flag = %d\n", all->philo->death_flag);
// 	while (i < all->philo_count)
// 	{
// 		pthread_create(&(all->thread[i]), NULL, (void *)thread_create, &(all->philo[i]));
// 		i++;
// 	}
// 	// i = 0;
// 	// while (i < all->philo_count)
